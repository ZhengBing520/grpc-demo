...
var protos_helloworld_pb = require('../protos/helloworld_pb.js');

function serialize_helloworld_HelloReply(arg) {
  if (!(arg instanceof protos_helloworld_pb.HelloReply)) {
...
function deserialize_helloworld_HelloReply(buffer_arg) {
  return protos_helloworld_pb.HelloReply.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_helloworld_HelloRequest(arg) {
  if (!(arg instanceof protos_helloworld_pb.HelloRequest)) {
...
function deserialize_helloworld_HelloRequest(buffer_arg) {
  return protos_helloworld_pb.HelloRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
sayHello: {
    ...
    requestType: protos_helloworld_pb.HelloRequest,
    responseType: protos_helloworld_pb.HelloReply,
